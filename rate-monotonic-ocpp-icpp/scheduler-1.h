...
#define resourceSCHEDULING_POLICY_ICPP 1 /* Rate-monotonic scheduling */
#define resourceSCHEDULING_POLICY_OCPP 2 /* Deadline-monotonic scheduling */
...
#define resourceSCHEDULING_POLICY resourceSCHEDULING_POLICY_OCPP
//schedSCHEDULING_POLICY_EDF
#define schedAUGMENT_SCHEDULER_TASK 0 /* Augment the scheduler to add
scheduler overhead*/
...
* uxPriority: Priority of the task. (Only used when scheduling policy is set to
manual)
* pxCreatedTask: Pointer to the task handle.
* xPhaseTick: Phase given in software ticks. Counted from when vSchedulerStart is
called.
...
TaskHandle_t *pxCreatedTask, TickType_t xPhaseTick, TickType_t
xPeriodTick, TickType_t xMaxExecTimeTick, TickType_t xDeadlineTick );
